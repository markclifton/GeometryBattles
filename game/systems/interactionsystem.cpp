...
void InteractionSystem::update(std::vector<ps::ecs::COMP_TYPE>, float, void** component)
{
    ...
    auto thisEntity = reinterpret_cast<ps::drawable::DrawableEntity*>(baseComponent->entityHandle);
    ...
    for(auto& entityRaw : ps::ECSManager::get().entities_)
    {
        ...
        {
            auto entity = reinterpret_cast<ps::drawable::DrawableEntity*>(entityRaw.get());
